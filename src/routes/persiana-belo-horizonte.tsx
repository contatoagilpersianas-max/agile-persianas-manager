...
export const Route = createFileRoute("/persiana-belo-horizonte")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://agilpersianasecortinas.lovable.app/og/lp-bh.jpg" },
      { name: "twitter:image", content: "https://agilpersianasecortinas.lovable.app/og/lp-bh.jpg" },
