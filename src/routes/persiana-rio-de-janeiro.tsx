...
export const Route = createFileRoute("/persiana-rio-de-janeiro")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://agilpersianasecortinas.lovable.app/og/lp-rio.jpg" },
      { name: "twitter:image", content: "https://agilpersianasecortinas.lovable.app/og/lp-rio.jpg" },
